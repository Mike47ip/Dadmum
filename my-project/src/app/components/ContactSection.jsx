...
const ContactSection = ({ contactRef }) => {
  return (
    <section ref={contactRef} className="py-16 bg-gray-800 text-white w-full">
      <div className="container mx-auto px-4 w-full max-w-none">
        ...
        <div className="flex flex-col lg:flex-row gap-8 w-full">
          <AnimatedSection delay={1} className="!w-[50%] ">
            <div className="w-full px-4">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <p>+233-56-067-2809 | +233-24-976-8534</p>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <p>dadmumticketingandchaterdfli@gmail.com</p>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <p>123 Aviation Way, Skyline Tower, Accra, Greater Accra Region, GH</p>
                </div>
              </div>
            </div>
          </AnimatedSection>
          
          <AnimatedSection delay={2} className="!w-[50%]">
            <div className="w-full px-4">
